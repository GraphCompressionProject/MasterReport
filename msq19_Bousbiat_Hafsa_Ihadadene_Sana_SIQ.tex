...
\newpage
	...
	\par
		...
		Nous avons présenté les différentes méthodes de compression existantes dans chacune des deux classes où nous essayé de mettre en relief les points fort de chacune. Nous avons ainsi établi une étude comparative entre elles en se basant sur leurs caractéristiques qui peuvent avoir une forte influence sur leur performance et oriente le choix de la méthode. 
